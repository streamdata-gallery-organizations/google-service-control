...
- name: Google Service Control API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-organizations/google-service-control/master/_listings/google-service-control/v1-services-servicename-startreconciliation-post.md
x-common:
- type: x-change-log
